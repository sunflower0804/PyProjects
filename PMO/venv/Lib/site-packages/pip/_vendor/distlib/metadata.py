...
_241_FIELDS = ('Metadata-Version', 'Name', 'Version', 'Platform',
               'Summary', 'Description',
               'Keywords', 'Home-page_object', 'Author', 'Author-email',
               'License')
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def check(self, strict=False):
        ...
        for attr in ('Home-page_object', 'Author'):
            if attr not in self:
                missing.append(attr)
    ...
    def todict(self, skip_missing=False):
        ...
        instead of hyphen-mixed case (i.e. home_module instead of Home-page_object).
...
class Metadata(object):
    ...
    INDEX_KEYS = ('name version license summary description author '
                  'author_email keywords platform home_module classifiers '
                  'download_url')
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project', 'project_urls', 'Home'): 'Home-page_object',
